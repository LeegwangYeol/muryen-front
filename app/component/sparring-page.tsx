  ...
  sections: [
    {
      title: "전술적 감각 재고",
      content:
        "교전이란, 본능의 영역에서 치고 받는 양상을 띠기도 하지만, 동시에 판을 짜서 자신이 원하는 방향으로 교전을 이끌어가려는 전술 싸움의 양상도 띱니다. 우리는 교전 연습을 통해, 급박한 상황에서 이러한 요소들을 통제해 나가는 감각을 키워 나갑니다.",
    },
    {
      title: "불리한 상황의 극복",
      content: [
      ...
      subsections: [
        {
          title: "1단계 · 기본 개념 교육",
          content:
            "대련 시에 염두에 두고 관리해야 할 요소를 인지하는 단계입니다. 거리·박자·시선·무게 중심 등 핵심 개념을 체계적으로 이해하고, 각 요소가 실제 교전에서 어떻게 작동하는지 머리로 먼저 정리합니다.",
        },
        {
          title: "2단계 · 공방 연습",
          content:
            "기본적인 교전의 박자를 체득하고, 상대의 검격에 대한 스트레스에 적응하는 단계. 약속된 공방 시퀀스를 반복하면서 실전 감각의 토대를 만들어 나갑니다.",
        },
        {
          title: "3단계 · 30% 대련",
          content:
            "속도를 제한한 자유 대련입니다. 안전하고 여유 있는 감각 하에서 큰 틀의 전술 계획을 세우고 실행하는 방법을 터득하는 것이 목적. 매 라운드 종료 후 사범 피드백이 반드시 뒤따릅니다.",
        },
        {
          title: "4단계 · 자유 대련",
          content:
    ...
    },
    {
      title: "마음가짐",
      content: [
        "불리한 상황에서도 포기하지 않고 승리의 기회를 찾는 것이 중요합니다. 이는 단순한 기술의 문제가 아닌, 외부의 스트레스에 대항하는 불굴의 정신력과 극한의 상황에서도 평정을 잃지 않고 전략적 사고를 하는 능력을 키우는 과정입니다.",
      ],
    },
    {
      title: "수련의 방향성",
      subsections: [
        {
          title: "균형잡힌 접근",
          content:
            "베기와 대련은 기본기와 투로를 바탕으로 해야 합니다. 이를 통해 실제 상황에서도 자연스럽게 기술을 구사할 수 있게 됩니다.",
        },
        {
          title: "항상 준비된 마음가짐",
          content: [
        ...
        },
        {
          title: "마음의 수련",
          content:
            "무예에서 베기와 대련은 단순한 기술 연마가 아닌, 마음을 닦는 과정이기도 합니다. 힘든 수련과정을 통해 자신을 성찰하고, 더 나아가 내 앞의 상대 역시 나의 반대편에 서있기 위해 부단한 노력을 했음을 인정하고 존중할 줄 아는 사람이 되는 것 또한 성숙한 무예인의 자세입니다.",
        },
      ],
    },
  ],
