...
const turoData = {
  ...
  overview: {
    ...
    description:
      "투로는 동작 반복을 통해 겉으로 보이는 동작을 완벽하게 소화해내고 체화하기 위해 수련한다고들 믿습니다. 분명히 그런 목적도 존재하지만, <span className='highlight-word'>무련</span>은 투로를 익힌다는 것은 하나의 무술서를 읽어내는 것과 같다는 생각 하에 수련을 진행하고 있어요. 우리가 책을 읽으면서 작가가 독자에게 무엇을 전달하고 싶어하는지를 생각하면서 읽듯이, 우리는 이 투로를 엮어낸 분께서 후학들에게 어떤 것들을 깨닫고 연습하기를 원하시는지를 생각하며 수련합니다.",
  },
  sections: [
    {
      title: "투로의 구성",
