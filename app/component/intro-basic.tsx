...
import { Book } from "./donut-chart";

const DonutChart = dynamic(() => import("./donut-chart"), {
  ssr: false,
  loading: () => (
    <div className="h-[800px] animate-pulse bg-white/5 rounded-lg border border-white/10 flex items-center justify-center text-sm text-gray-400">
      차트 로딩 중...
    </div>
  ),
});
